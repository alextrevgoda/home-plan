...
export const CATALOG: CatalogItem[] = [
  ...
  // living room
  { id: 'sofa-3seat', name: 'Sofa (3-seat)', category: 'living', mount: 'floor', layer: 'solid', defaultSize: s(2.2, 0.95, 0.85), sizeBounds: b(s(1.6, 0.8, 0.7), s(2.8, 1.1, 1.0)), modelPath: 'models/sofa-3seat.glb', symbolId: 'sofa', recolorMaterial: 'carpet' },
  { id: 'armchair', name: 'Armchair', category: 'living', mount: 'floor', layer: 'solid', defaultSize: s(0.85, 0.85, 0.85), sizeBounds: b(s(0.7, 0.7, 0.7), s(1.1, 1.1, 1.0)), modelPath: 'models/armchair.glb', symbolId: 'armchair', recolorMaterial: 'carpet' },
