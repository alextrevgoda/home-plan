...
export const CATALOG: CatalogItem[] = [
  ...
  // living room
  { id: 'sofa-3seat', name: 'Sofa (3-seat)', category: 'living', mount: 'floor', layer: 'solid', defaultSize: s(2.2, 0.95, 0.85), sizeBounds: b(s(1.6, 0.8, 0.7), s(2.8, 1.1, 1.0)), modelPath: 'models/sofa-3seat.glb', symbolId: 'sofa', recolorMaterial: 'sofa_02', modelRotationY: -Math.PI / 2 },
  ...
  { id: 'dining-chair', name: 'Dining chair', category: 'kitchen', mount: 'floor', layer: 'solid', defaultSize: s(0.45, 0.5, 0.9), sizeBounds: b(s(0.4, 0.4, 0.8), s(0.55, 0.6, 1.1)), modelPath: 'models/dining-chair.glb', symbolId: 'chair', modelRotationY: Math.PI / 2 },
